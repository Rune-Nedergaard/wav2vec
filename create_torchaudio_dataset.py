...
# %%
######### Testing on original arctic to get baseline error #########
import pandas as pd
import os
import shutil
import glob

src_path = 'c:\\Users\\rune7\\Documents\\GitHub\\wav2vec\\data\\ARCTIC\\cmu_us_aew_arctic\\wav'
dst_path = 'c:\\Users\\rune7\\Documents\\GitHub\\wav2vec\\data\\ARCTIC\\renamed'

filenames = os.listdir("data\\ARCTIC\\cmu_us_aew_arctic\\wav")

#renaming files such that it matches what STTDataset expects
for count, name in enumerate(filenames):
    shutil.copyfile(src_path + '\\' + name,dst_path + '\\' + str(count) + '.wav')
